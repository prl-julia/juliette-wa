...
(module+ test
  ...
  (test-equal (judgment-holds (⊢ ,yfloat-bBool (pcall && b y) Any)) #false)
  (test-equal (judgment-holds (⊢ ,yfloat-bBool (pcall == b y) Bool)) #true)
  (test-equal (judgment-holds (⊢ ,yfloat-bBool (pcall print b y) Any)) #false)
  (test-equal (judgment-holds (⊢ ,yfloat-bBool (pcall print b) Nothing)) #true)
  (test-equal (judgment-holds (⊢ ,yfloat-bBool (pcall + b y 1.1) Any)) #false)
  (test-equal (judgment-holds (⊢ ,yfloat-bBool (if b y 1.1) Any)) #false)
